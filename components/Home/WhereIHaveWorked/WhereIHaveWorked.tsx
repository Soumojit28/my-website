...
import Oxytocin from "./Descriptions/Oxytocin";
import Predictram from "./Descriptions/Predictram";
import Cdac from "./Descriptions/Cdac";
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("Oxytocin");
  return (
    <div
      data-aos="fade-up"
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        <div className="flex flex-row md:flex-col">
          <CompanyButton
            ...
            CompanyName="Oxytocin"
            BarPosition={-12}
            BarAvobePosition={1}
            DescriptionJob="Oxytocin"
            CompanyNameBackgroundColorGreen={[true, false, false]}
            setDescriptionJob={props.setDescriptionJob}
          />
          <CompanyButton
            ButtonOrderOfcompanyNameBackgroundColorGreen={1}
            CompanyName="Predictram"
            BarPosition={32}
            BarAvobePosition={129}
            DescriptionJob="Predictram"
