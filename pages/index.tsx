  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://soumojit.in`} />
        <link rel="canonical" href={`https://soumojit.in`} />
